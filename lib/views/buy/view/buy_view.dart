...
import 'package:rasid_jack/views/buy/bloc/buy_bloc.dart';

class BuyView extends BaseStatefulWidget {
  @override
  _MainViewState createState() => _MainViewState();
}

class _MainViewState extends BaseState<BuyView> {
  BuyBloc bloc = BuyBloc(payNumber: '0');
  @override
